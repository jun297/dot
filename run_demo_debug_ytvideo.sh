#!/bin/bash
python demo_debug.py --visualization_modes spaghetti_last_static --video_path juLxWt_3omw.mp4 \
    --sim_tracks 1024 --num_tracks 1024 \
    --width 320 --height 240 \
    --data_root ../../demo_video
# --width 320 --height 240 \


# maybe we can reduce down the 


# To check options, python demo --help
